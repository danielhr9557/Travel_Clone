...
function SearchingBar () {
  ...
  return (
    <div className="searching-bar-main-container">
      {/* Botones para iniciar Modal */}
      <div className="searching-bar-container  d-flex">
       
          <button type="button" className="btn btn-left search-group flex-grow-1" data-bs-toggle="modal" data-bs-target="#searchModal" onClick={() => handdleActiveTab('tab1')}>
            A cualquier lugar del mundo
          </button>
          <button type="button" className="btn btn-middle search-group flex-grow-1" data-bs-toggle="modal" data-bs-target="#searchModal" onClick={() => handdleActiveTab('tab2')}>
            ¿Cuándo?
          </button>
          ...
          <button type="button" className="btn btn-right search-group flex-grow-1" data-bs-toggle="modal" data-bs-target="#searchModal" onClick={() => handdleActiveTab('tab4')}>
            ¿Cuántos van?      
